...
static bool DOS_MultiplexFunctions(void) {
	...
	case 0x0600:	/* Guess - ASSIGN - INSTALLATION CHECK */
		LOG_MSG("Unhandled 0600h call AX=%04x BX=%04x CX=%04x DX=%04x BP=%04x",reg_ax,reg_bx,reg_cx,reg_dx,reg_bp);
		//reg_al = 0x00; // not installed
		break;
	case 0x1500:	/* Guess - CD-ROM - INSTALLATION CHECK */
		LOG_MSG("Unhandled 1500h call AX=%04x BX=%04x CX=%04x DX=%04x BP=%04x",reg_ax,reg_bx,reg_cx,reg_dx,reg_bp);
		break;
