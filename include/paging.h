...
#define PFLAG_HASCODE32		0x8				//Page contains dynamic code
...
bool mem_unalignedwritew_checked(const PhysPt address,const Bit16u val);
bool mem_unalignedwrited_checked(const PhysPt address,const Bit32u val);
